...
// One-time / guest volunteer groups (public /guest-hours form + guest_organizations table).
// NOTE: correct spelling is 'Noorda' — SCHOOLS above has a legacy 'Norda' typo; do not reuse it here.
// Self-contained model: no profiles rows, no shifts.role value. Guest hours
// live only in guest_hours_submissions and merge at read time.
export const GUEST_ORG_NAMES = ['Noorda', 'UVU PA', 'UVU Nursing']
...
export const ACTION_LABELS = {
  ...
  deactivated_guest_org: 'Deactivated guest org', reactivated_guest_org: 'Reactivated guest org',
  created_guest_org: 'Created guest org',
}
export const ACTION_COLORS = {
  ...
  deactivated_guest_org: '#f87171', reactivated_guest_org: '#4ade80',
  created_guest_org: '#a78bfa',
}
