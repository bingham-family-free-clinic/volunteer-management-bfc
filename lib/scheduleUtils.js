...
export function recurringAppliesToDate(recurring, dateStr) {
  ...
  // Week of Year: Jan 1 = week 1, increment every 7 days
  const startOfYear = new Date(d.getFullYear(), 0, 1)
  const weekOfYear  = Math.ceil(((d - startOfYear) / 86400000 + startOfYear.getDay() + 1) / 7)

  if (recurring.week_pattern === 'odd')  return weekOfYear % 2 === 1
  if (recurring.week_pattern === 'even') return weekOfYear % 2 === 0
  return false
}
/**
